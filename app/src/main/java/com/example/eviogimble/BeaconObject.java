...
public class BeaconObject {
    ...
    public String toString() {
        JSONObject Beacon_object = new JSONObject();
        try{
            Beacon_object.put("beaconType",beaconType);
            Beacon_object.put("name",name);
            Beacon_object.put("RSSI",RSSI);
            Beacon_object.put("id",id);
            Beacon_object.put("distance",distance);
            Beacon_object.put("temperature",temperature);
            Beacon_object.put("timestamp",timestamp);
            Beacon_object.put("batteryLevel",batteryLevel);

        }catch (Exception e){
            e.printStackTrace();
        }

        String str = Beacon_object.toString();
        return str;
    }
}
